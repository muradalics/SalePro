...
class ProductController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('products-index')){
            ...
            $role_id = $role->id;
            return view('backend.product.index', compact('all_permission', 'role_id'));
        }
        else
    ...
    public function create()
    {
        ...
        if ($role->hasPermissionTo('products-add')){
            ...
            return view('backend.product.create',compact('lims_product_list_without_variant', 'lims_product_list_with_variant', 'lims_brand_list', 'lims_category_list', 'lims_unit_list', 'lims_tax_list', 'lims_warehouse_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
